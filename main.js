...
//          Function to represent the categories of the recipes
...
//          Function to get basic data about items in a particular category i.e. Breakfast
...
//          Function to get all the data about a particular recipe using its item id
...
async function showFullRecipe(recipeId){
    ...
    screen.recipe.querySelector(".back-btn").addEventListener("click", function(){
        ...
        screen.recipe.querySelector(".detail ul").innerHTML = "";
